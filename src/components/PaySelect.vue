...
function showPaymentLoading() {
  MessageBox.paymentLoading(t('please_complete_the_payment_on_the_opened_page'), t('cancel'), () => {
    console.log('取消支付')
    handleModalClose()
  })
}
...
function showPaymentSuccess() {
  MessageBox.paymentSuccess(t('payment_success'), t('confirm'), () => {
    handleClose()
...
function showPaymentFailed() {
  MessageBox.paymentFailed(t('payment_failed'), t('confirm'), () => {
    // handleClose()
    console.log('确定')
  })
}
...
function showOrderFailed() {
  MessageBox.orderFailed(t('order_failed'), t('confirm'), () => {
    handleClose()
    console.log('确定')
  })
}
